...
public class QuizActivity extends AppCompatActivity {
    ...
    private HashMap<Integer, Long> questionTimeMap = new HashMap<>();
    ...
    private void showQuestion(int index) {
        ...
        questionStartTime = System.currentTimeMillis(); // start time for this question
    ...
    private void saveAnswer(int selectedOption) {
        ...
        long timeSpent = questionEndTime - questionStartTime;
        questionTimeMap.put(currentIndex, timeSpent);
    }
    ...
    private void nextQuestion() {
        if (currentIndex < questionList.size() - 1) {
            ...
            quizEndTime = System.currentTimeMillis(); // end of quiz
            openResultActivity();
        }
    }
    ...
    private void openResultActivity() {
        ...
        for (int i = 0; i < questionList.size(); i++) {
            ...
            int ans = userAnswers.getOrDefault(i, -1);
            if (ans == q.getAnswer()) correctAnswers++;

            totalTime += questionTimeMap.getOrDefault(i, 0L);
        }

        Intent i = new Intent(this, com.example.codequerst.Activity.ResultActivity.class);
        i.putExtra("questionList", new ArrayList<>(questionList));
        i.putExtra("userAnswers", userAnswers);
        i.putExtra("language", language);
        i.putExtra("topic", topic);
        i.putExtra("quizStartTime", quizStartTime);
