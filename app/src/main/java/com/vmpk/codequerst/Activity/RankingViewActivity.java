...
public class RankingViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String imageValue = getIntent().getStringExtra("image");
        ...
        // 🔥 FIXED IMAGE HANDLING (URL + AVATAR)
        setProfileImage(imageValue, name);
    ...
    // ===================================================
    // 🔹 Image Handler (Avatar + URL)
    // ===================================================
    private void setProfileImage(String imageValue, String name) {
